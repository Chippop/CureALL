"""
    The code is modified from the original code from the following repository:
    https://github.com/snap-stanford/UCE/blob/main/model.py
"""
...
class UCETransformerModel(nn.Module):
    """
    UCE Transformer models.
    """
    ...
    def __init__(
        ...
        encoder_layers = TransformerEncoderLayer(d_model, n_heads, ffn_size, dropout)
